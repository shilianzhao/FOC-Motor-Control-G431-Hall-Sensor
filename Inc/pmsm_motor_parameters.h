...
#define NOMINAL_CURRENT         15370
#define MOTOR_MAX_SPEED_RPM     7986 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  1.4 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -15370 /*!< Demagnetization current */
