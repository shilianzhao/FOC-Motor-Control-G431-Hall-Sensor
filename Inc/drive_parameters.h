...
#define MAX_APPLICATION_SPEED_RPM       7986 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT         287
#define PID_TORQUE_KI_DEFAULT         216
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           287
...
#define PID_SPEED_KP_DEFAULT          2286/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          304/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
